...
'**
'@author <a href="mailto:vbjson@ediy.co.nz">Michael Glaser</a>
'@revision Дата ревизии: 16.06.2011 г., время: 5:24:37
'@rem <h1><b>JSON</b></h1>
'Сайт: <a href="http://code.google.com/p/vba-json/">VBA JSON project</a>
'<pre>
'--------------------------------------------------------------------------------
' Проект   :       Конфигуратор управляющих программ
' Модуль   :       JSON
' Описание :       VBJSON is a VB6 adaptation of the VBA JSON project
' Автор    :       Michael Glaser
' Изменён  :       16.06.2011 г., время: 5:24:37
'--------------------------------------------------------------------------------
    ...
    Select Case VarType(obj)
        ...
        Case vbObject
            ...
            If TypeName(obj) = "Dictionary" Then
                ...
                SB.Append "{" & VBA.Constants.vbCrLf
                Dim keys
                keys = obj.keys

                For I = 0 To obj.Count - 1

                    If bFI Then bFI = False Else SB.Append "," & VBA.Constants.vbCrLf
                    Dim key
                    key = keys(I)
