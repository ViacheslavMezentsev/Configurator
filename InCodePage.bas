...
'**
'@rem error for invalid chars
Public Const MB_ERR_INVALID_CHARS = &H8

'**
'@rem check for default char
Public Const WC_DEFAULTCHECK = &H100
'**
'@rem convert composite to precomposed
Public Const WC_COMPOSITECHECK = &H200
'**
'@rem discard non-spacing chars
Public Const WC_DISCARDNS = &H10
'**
'@rem generate separate chars
Public Const WC_SEPCHARS = &H20
'**
'@rem replace w/ default char
...
'--------------------------------
Public Function AToW(ByVal st As String, Optional ByVal cpg As Long = -1, _
...
'**
'@param        st Required. String.
'@param        lcid Optional. Long. Default value is -1.
'@param        lFlags Optional. Long. Default value is 0.
'@return       String.
'@rem <pre>
'----------------------------------------------------------------------------------------
'   AToWEx
...
'**
'@param        st Required. String.
'@param        cpg Optional. Long. Default value is -1.
'@param        lFlags Optional. Long. Default value is 0.
'@return       String.
'@rem <pre>
'--------------------------------
